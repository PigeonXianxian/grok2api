...
from .xai_oauth import router as _xai_oauth_router  # noqa: E402
from .cli_quota import router as _cli_quota_router  # noqa: E402
...
router.include_router(_xai_oauth_router)
router.include_router(_cli_quota_router)
